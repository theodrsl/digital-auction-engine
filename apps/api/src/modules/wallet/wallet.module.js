    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                ...
                { name: ledger_schema_1.LedgerEntryModel.name, schema: ledger_schema_1.LedgerEntrySchema },
            ]),
        ],
        providers: [wallet_repo_1.WalletRepo, ledger_repo_1.LedgerRepo, wallet_service_1.WalletService],
